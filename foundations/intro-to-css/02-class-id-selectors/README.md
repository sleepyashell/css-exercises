...
### Self Check
- Do the odd numbered `p` elements share a class? Answer: Yes
- Do the even numbered `div` elements have unique IDs? Answer: Yes
- Does the Number 3 element have multiple classes? Answer: Yes
